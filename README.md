...
最新安装包：[`EhViewer_OHOS_0.5.3.hap`](https://github.com/suibianqwe/Ehviewer_OHOS/releases/download/v0.5.3/EhViewer_OHOS_0.5.3.hap)<br />
发布包类型：未签名 HAP  
目标API：`26.0.0`  
兼容API：`6.0.0(20)`  
...
- 翻译：支持列表标题、详情标题与评论翻译，可选网页翻译、DeepSeek、OpenAI、Gemini 和自定义兼容 API。
