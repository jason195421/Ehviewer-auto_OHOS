...
- Gallery list parsing now follows the original Android row extraction more closely for favorites, uploader/page metadata, favorite slot colors and pixel-based `.ir` rating stars.
- Gallery empty/loading/error states now render in the main content area instead of the compact toolbar status strip.
